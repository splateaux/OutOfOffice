...
namespace SoftProGameWindows
{
    ...
    public class TextBox : IKeyboardSubscriber
    {
        ...
        public String Text
        {
            ...
            set
            {
                ...
                if (_text != "")
                {
                    ...
                    _text = this.MaxLength > 0 ? filtered.Substring(this.MaxLength) : filtered;
        ...
        public void Draw(SpriteBatch spriteBatch, GameTime gameTime)
        {
            ...
            spriteBatch.Draw(_textBoxTexture, new Rectangle(X, Y, Width, _textBoxTexture.Height / 2), new Rectangle(0, Highlighted ? (_textBoxTexture.Height / 2) : 0, _textBoxTexture.Width, _textBoxTexture.Height / 2), Color.White);
